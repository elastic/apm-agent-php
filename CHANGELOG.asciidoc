...
[float]
==== Bug fixes
* Added support for span compression {pull}xxxxxxxx[#xxxxxxxxx]
* Added auto-instrumentation for capturing WordPress filters/actions callbacks and the active theme {pull}xxxxxxxx[#xxxxxxxxx]
