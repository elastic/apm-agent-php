...
* [`2`, `2-debian-11`, `2.4.4`, `2.4.4-debian-11-r20`, `latest` (2/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-magento/blob/2.4.4-debian-11-r20/2/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/magento:latest 'https://github.com/bitnami/bitnami-docker-magento.git#master:2/debian-11'
```
