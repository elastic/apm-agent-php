...
class getBlogControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.GFLEsAc'] ?? $container->load('get_ServiceLocator_GFLEsAcService'))->withContext('App\\Controller\\Admin\\BlogController', $container));
