...
class __TwigTemplate_44fd708b6cbdf2ea6679d7a8eb26b26a extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["paginator"]) || array_key_exists("paginator", $context) ? $context["paginator"] : (function () { throw new RuntimeError('Variable "paginator" does not exist.', 27, $this->source); })()), "hasToPaginate", [], "any", false, false, false, 27)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 37
                echo "                    ";
                if (($context["i"] == twig_get_attribute($this->env, $this->source, (isset($context["paginator"]) || array_key_exists("paginator", $context) ? $context["paginator"] : (function () { throw new RuntimeError('Variable "paginator" does not exist.', 37, $this->source); })()), "currentPage", [], "any", false, false, false, 37))) {
                    // line 38
...
{% endblock %}
", "blog/index.html.twig", "/var/www/symfony/symfony-demo/templates/blog/index.html.twig");
    }
}
