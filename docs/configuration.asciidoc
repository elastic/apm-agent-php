...
- any positive value (e.g. `5ms`) - it limits stack trace collection to spans with durations
...
- any negative value (e.g. `-1ms`) - disable stack trace collection for spans completely
