...
function remove_extension_configuration_to_file() {
    ...
    sed -i${BACKUP_EXTENSION} '/; THIS IS AN AUTO-GENERATED FILE by the Elastic PHP agent post-install.sh script/{:a;N;/; END OF AUTO-GENERATED by the Elastic PHP agent post-install.sh script/!ba};/\(extension=|elastic_apm.bootstrap_php_part_file=\).*/d' "$1"
}
