...
enum OptionId
{
    ...
    optionId_devInternalSimulateMinServerLatency,
...
#define ELASTIC_APM_CFG_OPT_NAME_DEV_INTERNAL_SIMULATE_MIN_SERVER_LATENCY "dev_internal_simulate_min_server_latency"
