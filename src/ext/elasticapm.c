...
PHP_INI_BEGIN()
    STD_PHP_INI_BOOLEAN( "elasticapm.enabled", ENABLED_CONFIG_DEFAULT_STR_VALUE, PHP_INI_PERDIR, OnUpdateBool, enabled, Config, ELASTICAPM_GLOBAL_STATE_CONFIG() )
    STD_PHP_INI_ENTRY( "elasticapm.server_url", SERVER_URL_CONFIG_DEFAULT_VALUE, PHP_INI_ALL, OnUpdateString, serverUrl, Config, ELASTICAPM_GLOBAL_STATE_CONFIG() )
    STD_PHP_INI_ENTRY_EX( "elasticapm.secret_token", SECRET_TOKEN_CONFIG_DEFAULT_VALUE, PHP_INI_ALL, OnUpdateString, secretToken, Config, ELASTICAPM_GLOBAL_STATE_CONFIG(), displaySecretIniValue )
