...
{
    ELASTICAPM_ASSERT( years >= 1900 );
    ELASTICAPM_ASSERT( ELASTICAPM_IS_IN_INCLUSIVE_RANGE( 1, months, 12 ) );
    ELASTICAPM_ASSERT( ELASTICAPM_IS_IN_INCLUSIVE_RANGE( 1, days, 31 ) );
    ELASTICAPM_ASSERT( ELASTICAPM_IS_IN_INCLUSIVE_RANGE( 0, hours, 23 ) );
    ELASTICAPM_ASSERT( ELASTICAPM_IS_IN_INCLUSIVE_RANGE( 0, minutes, 59 ) );
    // seconds after the minute - [0, 60] including leap second
    ELASTICAPM_ASSERT( ELASTICAPM_IS_IN_INCLUSIVE_RANGE( 0, seconds, 60 ) );
    ELASTICAPM_ASSERT( ELASTICAPM_IS_IN_END_EXCLUDED_RANGE( 0, microseconds, 1000*1000 ) );
