...
class StackTraceLimitUnitTest extends TracerUnitTestCaseBase
{
    /**
    ...
    public function testVariousConfigValues(MixedMap $testArgs): void
    {
        ...
        StackTraceLimitTestSharedCode::implTestVariousConfigValuesAssertPart($expectedMaxNumberOfFrames, $this->mockEventSink->dataFromAgent);
    }
}
