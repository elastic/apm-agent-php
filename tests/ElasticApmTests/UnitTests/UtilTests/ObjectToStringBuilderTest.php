...
class ObjectToStringBuilderTest extends TestCase
{
    ...
    public function testClassToTestObjectToStringBuilder(): void
    {
        ...
        self::assertStringContainsString(
            '"type": "' . DbgUtil::fqToShortClassName(ClassToTestObjectToStringBuilder::class) . '"',
            $str
        );
    ...
    public function testDerivedClassToTestObjectToStringBuilder(): void
    {
        ...
        self::assertStringContainsString(
            '"type": "' . DbgUtil::fqToShortClassName(DerivedClassToTestObjectToStringBuilder::class) . '"',
            $str
        );
        self::verifyClassToTestObjectToStringBuilder($str);
    ...
    public function testTransaction(): void
    {
        ...
        $deps->logSink = new LogSinkForTests(__CLASS__ . '::' . __METHOD__);
        $tx = new Transaction(
            new Tracer($deps),
            'test_TX_name',
            'test_TX_type',
