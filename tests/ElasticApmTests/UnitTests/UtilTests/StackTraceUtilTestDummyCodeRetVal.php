...
final class StackTraceUtilTestDummyCodeRetVal
{
    ...
    public $dbgStackTrace;

    /**
     * @param StackTraceFrameExpectations[] $expectations
     * @param StackTraceFrame[]             $actual
     */
    public function __construct(array $expectations, array $actual)
    {
        $this->expectations = $expectations;
        $this->actual = $actual;
        $this->dbgStackTrace = debug_backtrace(/* options */ DEBUG_BACKTRACE_IGNORE_ARGS);
    }
}
