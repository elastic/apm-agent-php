...
final class SpanContextDestinationDto
{
    ...
    /** @var ?SpanContextDestinationServiceDto */
    public $service = null;
    ...
    public static function deserialize($value): self
    {
        ...
        DeserializationUtil::deserializeKeyValuePairs(
            ...
            function ($key, $value) use ($result): bool {
                switch ($key) {
                    case 'service':
                        $result->service = SpanContextDestinationServiceDto::deserialize($value);
                        return true;
                    default:
                        return false;
                }
    ...
    {
        $this->assertMatches(new SpanContextDestinationExpectations());
    }

    public function assertMatches(SpanContextDestinationExpectations $expectations): void
    {
        SpanContextDestinationServiceDto::assertNullableMatches($expectations->service, $this->service);
    }

    public static function assertNullableMatches(
        SpanContextDestinationExpectations $expectations,
        ?self $actual
    ): void {
        if ($actual === null) {
